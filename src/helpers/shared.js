import { defineComputed, isComputedDefinition, isPlainObject } from "../define.js";
...
export function createHelperExports({
  FLOW_INSPECT,
  FLOW_INSTANCE,
  createComputed: createLiveComputed,
  createStatus
}) {
const status = createStatus;

function set(nameOrUpdates, maybeValue) {
...
function dispatch(targetOrEventName, eventNameOrPayload, maybePayload) {
...
function after(ms, eventName, input) {
...
function when(predicate, options) {
...
function onError(handle, handler) {
...
function guard(predicate, handler, options) {
  if (typeof handler !== "function") {
...
function transition(statusTarget, config) {
...
function can(statusNameOrFlowOrEventName, eventName, input) {
...
function matches(statusNameOrRef, value) {
